...
if __name__ == '__main__':
    ...
    orthodontist_choice = DialogueChoice(json_path="results.json", json_key="specialty", json_value="orthodontist", keywords={"orthodontist", "dentist"})
    oculist_choice = DialogueChoice(json_path="results.json", json_key="specialty", json_value="oculist", keywords={"oculist"})
    psychiatrist_choice = DialogueChoice(json_path="results.json", json_key="specialty", json_value="Psychiatrist", keywords={"psychiatrist"})
    specialist_choices = {orthodontist_choice, oculist_choice, psychiatrist_choice}
    specialist_node = DialogueNode(specialist_choices)

    ## Care choice declarations
    specialist_choice = DialogueChoice(json_path="results.json", json_key="care", json_value="specialist", keywords={"specialist", "specialists"}, successor=specialist_node)
    occupational_choice = DialogueChoice(json_path="results.json", json_key="care", json_value="occupational", keywords={"occupational"})
    primary_choice = DialogueChoice(json_path="results.json", json_key="care", json_value="primary", keywords={"primary"})
